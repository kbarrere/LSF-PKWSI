...
if __name__ == '__main__':
	...
	parser.add_argument('--max_height', default=-1, action='store_true', help='max height to print')
	parser.add_argument('--max_width', default=-1, action='store_true', help='max width to print')
