...
parser.add_argument('--additional-results', nargs='+', help='files containing addiional information')
...
if args.additional_results:
	for kws_result_file in args.additional_results:
